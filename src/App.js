...
const projects = [
  {
    ...
    hook:
      'The project I did for my Bachelor Thesis which focused on providing a universal solution to monitoring Virtual Machines and visualizing and analyzing their cost and specifically waste.',
  ...
  },
  {
    title: 'Tulip Assist',
    hook:
      'The insurance company for which I worked and the details of my efforts to automate and improve the company.',
  ...
  },
  {
    ...
    hook:
      'A SaaS source of truth data base for more accurate API communication in a microservice system architecture.',
  ...
  },
  {
    title: 'Wander',
    hook:
      'An android application which allows the psychology department at the University of Groningen and other universities to run a specific test on study participants in a variety of conditions from their smartphones.',
  ...
  },
  {
    ...
    hook:
      'Available on request, a collection of my code that I wrote for university projects.',
...
const blogPosts = [
  {
    title: 'Who Am I?',
    hook:
      'Who am I? How can you find me?  What do I like to develop?  What do I do?',
    url: '/content/aboutme',
  ...
  },
  {
    ...
    hook:
      "I've worked on some interesting stuff in my relatively short time as a Software Engineer.  Read about stuff I've made and maybe even stuff I'm planning to make!",
    url: '/projects',
